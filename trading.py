...
ax.plot(ohlc['date'], ohlc['bollinger_upper'], color='orange', label='Bollinger upper')
ax.plot(ohlc['date'], ohlc['bollinger_lower'], color='orange', label='Bollinger lower')

ax.fill_between(ohlc['date'], ohlc['bollinger_upper'], ohlc['bollinger_lower'], alpha=0.3)
